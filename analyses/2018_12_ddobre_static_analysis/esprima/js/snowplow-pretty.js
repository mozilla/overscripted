        ...
        (function() {
            ...
            i.Tracker = function m(bb, aK, Q, a2, B, av) {
                var z = o(true, function(bh) {
                    ...
                    af, av = av || {},
                    aE = "GET",
                    J = av.hasOwnProperty("platform") ? av.platform : "web",
                    x, aW = av.hasOwnProperty("appId") ? av.appId : "",
                    aq, aI = am.title,
                    C, aD = av.hasOwnProperty("pageUnloadTimer") ? av.pageUnloadTimer : 500,
                    E, R, F, a7 = av.hasOwnProperty("cookieName") ? av.cookieName : "_sp_",
                    H = av.hasOwnProperty("cookieDomain") ? av.cookieDomain : null,
                    a8 = "/",
                    X = S.doNotTrack || S.msDoNotTrack,
                    a0 = av.hasOwnProperty("respectDoNotTrack") ? av.respectDoNotTrack && (X === "yes" || X === "1") : false,
                    ai, K = 63072000,
                    O = av.hasOwnProperty("sessionCookieTimeout") ? av.sessionCookieTimeout : 1800,
                    ...
                    ax = av.hasOwnProperty("useCookies") ? av.useCookies : true,
                    I = S.userLanguage || S.language,
                    aX = q.detectBrowserFeatures(ax, N("testcookie")),
                    y = (av.userFingerprint === false) ? "" : q.detectSignature(T),
                    M = bb + "_" + aK,
                    aH = false,
                    aF, a6 = new Date().getTime(),
                    aB, ar, an, Z, ab = p,
                    aJ, aj, W, V = 1,
                    bg, D = aQ(),
                    u = r.getLinkTrackingManager(z, M, a4),
                    ao = f.getFormTrackingManager(z, M, a4),
